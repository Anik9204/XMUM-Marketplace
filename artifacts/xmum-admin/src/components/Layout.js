...
import { LayoutDashboard, Flag, Users, Megaphone, FileText, Star, List, BarChart2, LogOut, Store, Newspaper, Moon, Sun, Menu, X, ShieldAlert, ClipboardList, SlidersHorizontal, Bell, } from "lucide-react";
...
export default function Layout({ children }) {
    ...
    useEffect(() => {
        const q = query(collection(db, "shops"), where("approvalStatus", "==", "pending"));
        const unsub = onSnapshot(q, (snap) => setPendingShopApprovals(snap.size), () => { });
        return unsub;
    }, []);
