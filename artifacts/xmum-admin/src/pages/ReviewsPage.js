...
import { collection, query, orderBy, onSnapshot, deleteDoc, doc, getDocs, where, updateDoc, increment, } from "firebase/firestore";
...
export default function ReviewsPage() {
    ...
    async function handleDelete(review) {
        ...
        try {
            ...
            const remaining = await getDocs(query(collection(db, "reviews"), where("sellerId", "==", review.sellerId)));
            if (remaining.empty) {
